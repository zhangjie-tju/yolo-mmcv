...
import sys
sys.path.append('/home1/jiezhang/yolov8/yolo-git/yolo-mmcv')
from mmdet import __version__
from yolo.apis import init_random_seed
from mmdet.apis import set_random_seed, train_detector
from mmdet.datasets import build_dataset
from yolo.models import build_detector
...
def parse_args():
    ...
    parser.add_argument(
        'config', default='configs/yolov5/train/pretrained/yolov5m/yolov5m_csp_mstrain_640_1x8_300e_voc.py', help='train config file path')
    parser.add_argument('--work-dir', default='/home1/jiezhang/yolov8/yolo-git/yolo-mmcv/work_dir',
